...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pick.event_date'
        db.alter_column(u'cappers_pick', 'event_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Pick.event_date'
        db.alter_column(u'cappers_pick', 'event_date', self.gf('django.db.models.fields.DateTimeField')())
