...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pick.event_date'
        db.add_column(u'cappers_pick', 'event_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 1, 12, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pick.event_date'
        db.delete_column(u'cappers_pick', 'event_date')
